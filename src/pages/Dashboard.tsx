  ...
  return (
    <div className="p-10">
      <div className="flex flex-col">
        <h1 className="text-3xl font-bold tracking-tight text-white-900">Bienvenido a Panaderia Emmanuel</h1>
        <div className="flex flex-col">
    ...
    <Link to={NavigateRoutes.MANAGE_PRODUCTS}>
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
        ...
        <h4 className="text-white font-medium text-large">Ver todos los productos</h4>
      </CardHeader>
      <Image
      isZoomed
        removeWrapper
    ...
    <Link to={NavigateRoutes.CREATE_MOVEMENT}>
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
        <p className="text-tiny text-white/60 uppercase font-bold">Movimientos</p>
        <h4 className="text-white font-medium text-large">Ver todos los movimientos</h4>
      </CardHeader>
      <Image
        isZoomed
        removeWrapper
    ...
    <Card className="col-span-12 sm:col-span-4 h-[300px]">
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
        <p className="text-tiny text-white/60 uppercase font-bold">Informes</p>
        <h4 className="text-white font-medium text-large">Ver todos los informes</h4>
      </CardHeader>
      <Image
      isZoomed
        removeWrapper
